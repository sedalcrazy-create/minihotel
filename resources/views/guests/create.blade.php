...
@section('title', 'افزودن مهمان')

@section('content')
<div class="card">
    <div class="card-header">
        <h2>افزودن مهمان جدید</h2>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form method="POST" action="{{ route('guests.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="national_code" id="national_code" class="form-control" value="{{ old('national_code') }}" maxlength="10">
            </div>
