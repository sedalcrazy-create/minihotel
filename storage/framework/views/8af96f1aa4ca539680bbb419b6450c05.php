...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'سیستم مدیریت خوابگاه - بانک ملی'); ?></title>
    <style>
        @font-face {
    ...
    <div class="header">
        <div class="header-content">
            ...
            <div class="header-nav">
                ...
                <a href="<?php echo e(route('personnel.index')); ?>">پرسنل</a>
                <a href="<?php echo e(route('reservations.index')); ?>">رزروها</a>
                <span style="color: rgba(255,255,255,0.8);"><?php echo e(auth()->user()->name); ?></span>
